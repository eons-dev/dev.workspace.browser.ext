/**
 * Adapted from Gitpod’s browser extension
 * https://github.com/gitpod-io/browser-extension
 * Original license: Apache-2.0
 */

export type SupportedApplication = "github" | "gitlab" | "bitbucket-server" | "bitbucket" | "azure-devops" | "eons-infrastructure";
...
// export const DEFAULT_HOSTS = ["github.com", "gitlab.com", "bitbucket.org", "dev.azure.com", "git.infrastructure.tech"];
export const DEFAULT_HOSTS = [];
export const isGitlabHost = () => /^git(?:lab)?\..*$/.test(window.location.host);
...
export const buttonContributions: ButtonContributionParams[] = [
	...
	// GitLab
	{
		...
		match: () => {
			return isGitlabHost() && !window.location.pathname.includes("/-/blob/");
		},
	...
	},
	{
		...
		match: () => {
			return isGitlabHost() && window.location.pathname.includes("/-/issues/");
		},
		selector:
